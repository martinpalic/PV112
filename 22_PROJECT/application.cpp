...
Application::Application(size_t initial_width, size_t initial_height) {
  ...
  this->main_program = create_program("shaders/main.vert", "shaders/main.frag");
...
void Application::render() {
  ...
  Walls bottom(camera_ubo);
  bottom.draw();

  GLuint program = create_program("shaders/main_textured.vert", "shaders/main_textured.frag");
  GLuint texture = load_texture_2d("models/skybox/bottom.jpg");
