...
int main(void) {
  ...
  // Task 5.4: Create window with ability to render multisample buffer
  //           using glfwWindowHint(GLFW_SAMPLES, count) function.
  //           Count should be power of two, try different options: 4, 8, 16.


  // Create window
  GLFWwindow *window = glfwCreateWindow(initial_width, initial_height, "04: Pipeline", NULL, NULL);
  if (!window) {
